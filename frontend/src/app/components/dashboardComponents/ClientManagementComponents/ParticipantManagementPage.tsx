...
import {getParticipants, getPrizes} from "@/app/api";
...
function ParticipantManagementPage() {
                            ...
                            {!loading && (
                                <>
                                    <Col key={"resultTikcets"}
                                         className={`w-100 d-flex justify-content-between mt-3 px-4 ${styles.clientsTableColDashboard}`}
                                         xs={24} sm={24} md={24} lg={24} span={6}>
                                        ...
                                        <div className={`${styles.clientsTableDashboard}`}>
                                            <ParticipantsTable key={clientsCount} selectedStoreId={null}
                                                               data={data as any}></ParticipantsTable>
                                        </div>
