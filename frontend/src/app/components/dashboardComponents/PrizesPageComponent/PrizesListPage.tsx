    ...
    const renderPrizes = () => {
        if (data) {
            return data.map((prize, key) => {
                return (
                    <Col key={key} className={`w-100 d-flex mt-5`} xs={24} sm={24} md={12} lg={8} span={6}>
                        <div className={`${styles.ticketCardElement}`}>
                            ...
                            <div className={`${styles.ticketCardBody}`}>
                                <div className={`${styles.prizeCardText} mb-1`}>
                                    ...
                                    <Button className={`${styles.eyeIcon} mt-3`}  title={`Plus de détails`} icon={<InfoOutlined />} size={"large"} >
                                    Détails
                                    </Button>

                                    <div className={`${styles.prizeCardFooter}`}>
                                        <p className={`${styles.prizeInfo}`}>Nombre de Tickets</p>
                                        <p className={`${styles.prizeInfo}`}>Nombre de Tickets Restant</p>
                                    </div>
                                    <div className={`${styles.prizeCardFooter}`}>
                                        <p className={`${styles.prizeInfoCounters}`}>{prize.totalCount}</p>
                                        <p className={`${styles.prizeInfoCounters}`}>{prize.totalCount}</p>
                                    </div>
                                    <div className={`${styles.prizeCardFooter}`}>
