...
import {Button, Card, Col, ConfigProvider, Form, Modal, Row, Space, Table} from "antd";
...
function BestGainsTable({selectedStoreId, data}: storeManagersTableProps) {
